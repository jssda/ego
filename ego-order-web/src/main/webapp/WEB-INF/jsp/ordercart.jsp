...
<form id="orderForm" class="hide" action="/order/save/" method="post">
    ...
    <input type="hidden" name="receiverAddress" value="西三旗 xxxxxxxxx"/>
</form>
                                            ...
                                            <div class="goods-suit goods-last">
                                                <c:forEach items="${carMap }" var="cart">
                                                    <div class="goods-item goods-item-extra">
                                                        ...
                                                        <div class="goods-msg">
                                                            <div class="p-name">
                                                                <a href="/item/${cart.value.item.id}.html"
                                                                   target="_blank">
                                                            ...
                                                            <div class="p-price">
                                                                ...
                                                                <strong>￥<fmt:formatNumber
                                                                        ...
                                                                        minFractionDigits="2"
                                                                        value="${cart.value.item.price / 100 }"/></strong>
                                                                <!--增加预售金额显示 end-->
                                                    ...
                                                    <ul>
                                                        <li class="mode-tab-item " id="jd_shipment_item"
                                                            onclick="doSwithTab('pay')"><span
                                                                ...
                                                                class='qmark-icon qmark-tip'
                                                                data-tips='由易购公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
