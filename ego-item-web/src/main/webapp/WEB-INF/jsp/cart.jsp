        ...
        <div class="cart-inner">
                    ...
                    <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
                        <div class="item_form clearfix">
                            <div class="cell p-checkbox"><input data-bind="cbid:1" class="checkbox" type="checkbox"
                                                                name="checkItem" checked=""
                                                                value="${cart.value.item.id}"></div>
                            <div class="cell p-goods">
                                <div class="p-img">
                                    <a href="http://localhost:8082/item/${cart.value.item.id }.html" target="_blank">
                                ...
                                <div class="p-name">
                                    <a href="http://localhost:8082/item/${cart.value.item.id }.html"
                            ...
                            <div class="cell p-price"><span class="price">¥<fmt:formatNumber groupingUsed="false"
                                                                                             value="${cart.value.item.price / 100}"
                                                                                             maxFractionDigits="2"
                            ...
                            <div class="cell p-quantity" for-stock="for-stock-11345721">
                                <div class="quantity-form" data-bind="">
                                    ...
                                    <input type="text" class="quantity-text" itemPrice="${cart.value.item.price}"
                                           itemId="${cart.value.item.id}" value="${cart.value.num}"
                            ...
                            <div class="cell p-remove"><a id="remove-11345721-1" data-more="removed-87.20-1"
                                                          ...
                                                          class="cart-remove"
                                                          href="/cart/delete/${cart.value.item.id}.html">删除</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
            ...
            <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;">
              ...
              <span class="column t-checkbox form">
                  ...
                  <a href="<%--javascript:void(0);--%>/delete/cart/all.html"
                     clstag="clickcart|keycount|xincart|clearcartlink" id="remove-batch">
                          清空购物车
                  </a>
              </span>
                        <span class="shopping">
                  ...
                  <a href="http://localhost:8081/" target="_self" clstag="clickcart|keycount|xincart|coudanlink"
                     id="continue">继续购物</a>
              </span>
                    </div>
                  ...
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://localhost:8086/order/cart"
